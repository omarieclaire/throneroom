...
function sceneSwitch(){"preline"==scene?scene="line":"line"==scene?(scene="toilet",displayWelcomeMessage(),leaveSceneTimer(standardTimer),noLoop()):"toilet"==scene?(stopSounds(),scene="sink",startIndex=120,endIndex=240,displayWelcomeMessage(),leaveSceneTimer(standardTimer),noLoop()):"sink"==scene?(stopSounds(),scene="mirror",startIndex=240,endIndex=360,displayWelcomeMessage(),leaveSceneTimer(standardTimer),noLoop()):"mirror"==scene&&(stopSounds(),scene="end",startIndex=360,endIndex=480,displayWelcomeMessage(),
